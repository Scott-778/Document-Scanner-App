...
class SaveViewController: UIViewController, ImageScannerControllerDelegate {
    ...
    func renamePDF(){
        let alertController = UIAlertController(title: NSLocalizedString("rename", comment: "Rename"), message: NSLocalizedString("enterNewName", comment: "Enter new document name"), preferredStyle: .alert)
               ...
               let confirmAction = UIAlertAction(title: NSLocalizedString("save", comment: "Save"), style: .default) { (_) in
    ...
    @IBAction func sharePDForJPEG(_ sender: Any) {
        ...
        alert.addAction(UIAlertAction(title: "PDF", style: .default, handler: { (a) in
        ...
        alert.addAction(UIAlertAction(title: "Zipped PDF", style: .default, handler: { (action) in
        ...
        alert.addAction(UIAlertAction(title: NSLocalizedString("image", comment: "image"), style: .default, handler: { (a) in
    ...
    @IBAction func ocr(_ sender: Any) {
        ...
        textRecognizer.process(vImage) { result, error in guard error == nil, let result = result else{
    ...
    @IBAction func addPageOrSignature(_ sender: Any) {
        ...
        let actionsheet = UIAlertController(title: nil, message: nil, preferredStyle: .actionSheet)
               ...
               actionsheet.addAction(UIAlertAction(title: NSLocalizedString("markup", comment: "markup"), style: .default, handler: { (a) in
        ...
        actionsheet.addAction(UIAlertAction(title: NSLocalizedString("addCamera", comment: "add pages with camera"), style: .default, handler: { (action) in
            self.scanImage()
        }))
        actionsheet.addAction(UIAlertAction(title: NSLocalizedString("addPhotos", comment: "add pages from photos"), style: .default, handler: { (action) in
            self.selectImage()
        }))
